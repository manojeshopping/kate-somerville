...
class Mage_Cms_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function noRouteAction($coreRoute = null)
    {
		...
		//Mage::log('IP: ' . $_SERVER['REMOTE_ADDR'] . " Forwarder for: " . $_SERVER['HTTP_X_FORWARDED_FOR'] . "  URI:  " . $_SERVER['REQUEST_URI'], null, 'ksv_noroute.log');
		Mage::log('IP: ' . $_SERVER['REMOTE_ADDR'] . "  URI:  " . $_SERVER['REQUEST_URI'], null, 'ksv_noroute.log');
