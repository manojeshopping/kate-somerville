...
class Enterprise_PageCache_Model_Observer
{
    ...
    public function customerLogin(Varien_Event_Observer $observer)
    {
        ...
        //clean cache for customer quote, for replacing with merged quote
        $cacheId = md5(Enterprise_PageCache_Model_Container_Advanced_Quote::CACHE_TAG_PREFIX
            . $this->_getCookie()->getObscured(Enterprise_PageCache_Model_Cookie::COOKIE_CART)
            . $this->_getCookie()->getObscured(Enterprise_PageCache_Model_Cookie::COOKIE_CUSTOMER));
