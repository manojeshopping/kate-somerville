...
class Enterprise_PageCache_Model_Cookie extends Mage_Core_Model_Cookie
{
    ...
    /**
     * Container for obscured cookies
     *
     * @var array
     */
    static protected $_obscuredCookie;
    ...
    public function setObscure(
        ...
        self::$_obscuredCookie[$name] = $value;
        return $this->set($name, $value, $period, $path, $domain, $secure, $httponly);
    }

    /**
     * Retrieve a member of the obscured cookies
     *
     * @param string $key
     * @return array|bool|string
     */
    public static function getObscured($key = null)
    {
        if (null === $key) {
            return self::$_obscuredCookie;
        }

        return (isset(self::$_obscuredCookie[$key])) ? self::$_obscuredCookie[$key] : false;
    }
     ...
     * @param string $formKey
     */
    public static function setCartCookieValue($value)
    {
        self::_setCookie(self::COOKIE_CART, $value);
    }
