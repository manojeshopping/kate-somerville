...
class Alliance_GiftOfChoice_Block_Giftofchoice extends Mage_Core_Block_Template
{
	...
	{
		$this->setTemplate('alliance_giftofchoice/giftofchoice.phtml');
	}
	...
	{
		$url = $this->getUrl('giftofchoice/index/addGift');
		return $url;
	}
