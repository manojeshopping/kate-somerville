 ...
 */
class Alliance_CouponGiftItem_Block_Adminhtml_Main extends Mage_Adminhtml_Block_Promo_Quote_Edit_Tab_Main
{  /**
    ...
    protected function _prepareForm()
    {
        ...
        $usesPerCouponFiled = $fieldset->addField('coupon_gift_item_skus', 'text', array(
            'name' => 'coupon_gift_item_skus',
            'label' => Mage::helper('salesrule')->__('Gift Items Sku'),
        ));
