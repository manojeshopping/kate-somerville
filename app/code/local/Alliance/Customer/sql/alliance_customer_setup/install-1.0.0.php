...
$setup->removeAttribute('customer', 'primary_skin_concern');
...
$installer->addAttribute('customer', 'primary_skin_concern', array(
...
$attribute_id = (int)$installer->getAttribute('customer', 'primary_skin_concern', 'attribute_id');
$options = array(
    'Acne',
    'Anti-Aging',
    'Acne & Anti-Aging',
...
$test_attribute = Mage::getSingleton('eav/config')->getAttribute('customer', 'primary_skin_concern');
$test_attribute->setData('sort_order', 120);
$used_in_forms = array(
    'checkout_register',
