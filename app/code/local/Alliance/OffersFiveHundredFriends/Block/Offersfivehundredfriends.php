...
class Alliance_OffersFiveHundredFriends_Block_Offersfivehundredfriends extends Mage_Core_Block_Template
{
	...
	{
		$this->setTemplate('alliance/offersfivehundredfriends/fivehundredfriends.phtml');
	}
	...
	{
		$url = $this->getUrl('offersfivehundredfriends/index/addGift');
		return $url;
	}
