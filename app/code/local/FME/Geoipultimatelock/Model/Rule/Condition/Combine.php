 ...
 */
 ...
 class FME_Geoipultimatelock_Model_Rule_Condition_Combine extends Mage_CatalogRule_Model_Rule_Condition_Combine
 {
      ...
      public function getNewChildSelectOptions()
      {
          ...
          foreach ($conditions as $index => $condition) {
              if (isset($condition['value']) && $condition['value'] == 'catalogrule/rule_condition_combine') {
                  $conditions[$index]['value'] = 'geoipultimatelock/rule_condition_combine';
                  break;
              }
          }
          return $conditions;
