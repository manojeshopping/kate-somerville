...
class Magestore_Storelocator_Model_Exporter extends Varien_Object{
    ...
    protected $_fieldstr = 'storelocator_id,name,status,address,city,state,country,zipcode,latitude,longtitude,fax,phone,email,link,zoom_level,image_name,tag_store';
