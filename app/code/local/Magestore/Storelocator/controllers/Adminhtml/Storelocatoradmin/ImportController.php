...
class Magestore_Storelocator_Adminhtml_Storelocatoradmin_Importcontroller extends Mage_Adminhtml_Controller_Action {
    ...
    public function importstoreAction() {
		...
		$editBlock->updateButton('back','onclick','setLocation(\''.$this->getUrl('adminhtml/storelocatoradmin_storelocator/index').'\')');
