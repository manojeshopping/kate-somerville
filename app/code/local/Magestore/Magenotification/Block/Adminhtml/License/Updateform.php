	...
	extends Mage_Adminhtml_Block_Template
{
	...
	{
		//return $this->getUrl('adminhtml/magenotification_license/upgrade',array('licensekey'=>$this->getLicensekey(),'_secure'=>true));
		return $this->getUrl('adminhtml/magenotification_license/upgrade',array('_secure'=>true));
	}
	
	public function getViewPriceUrl()
	{
		//return $this->getUrl('adminhtml/magenotification_license/viewprice',array('licensekey'=>$this->getLicensekey(),'_secure'=>true));
		return $this->getUrl('adminhtml/magenotification_license/viewprice',array('_secure'=>true));
	}
