...
class Wyomind_Datafeedmanager_Block_Adminhtml_Configurations_Renderer_Action extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Action {
    ...
    public function render(Varien_Object $row) {
        $this->getColumn()->setActions(
                array(
                    array(
                        'url' => $this->getUrl('*/datafeedmanager_configurations/edit', array('id' => $row->getFeed_id())),
                        'caption' => Mage::helper('datafeedmanager')->__('Edit'),
                    ),
                    array(
                        'url' => $this->getUrl('*/datafeedmanager_configurations/delete', array('id' => $row->getFeed_id())),
                    ...
                    array(
                        'url' => $this->getUrl('*/datafeedmanager_configurations/sample', array('feed_id' => $row->getFeed_id(), 'limit' => 10)),
                    ...
                    array(
                        'url' => $this->getUrl('*/datafeedmanager_configurations/generate', array('feed_id' => $row->getFeed_id())),
                    ...
                    array(
                        'url' => $this->getUrl('*/datafeedmanager_configurations/export', array('feed_id' => $row->getFeed_id())),
