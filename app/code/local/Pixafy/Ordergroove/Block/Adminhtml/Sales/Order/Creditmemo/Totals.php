<?php
/**
 * OrderGroove rewrite of the Sales_Order_Creditmemo_Totals
 ...
 */
class Pixafy_Ordergroove_Block_Adminhtml_Sales_Order_Creditmemo_Totals extends Mage_Adminhtml_Block_Sales_Order_Creditmemo_Totals
{
