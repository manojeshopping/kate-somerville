 ...
 */ 
class Amasty_Shiprules_Model_Mysql4_Rule extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amshiprules/rule', 'rule_id');
    }
    ...
    public function getAttributes()
    {
        ...
        $tbl   = $this->getTable('amshiprules/attribute');
