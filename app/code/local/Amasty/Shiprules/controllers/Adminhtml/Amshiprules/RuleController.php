 ...
 */ 
class Amasty_Shiprules_Adminhtml_Amshiprules_RuleController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _isAllowed(){
        return Mage::getSingleton('admin/session')->isAllowed('sales/amshiprules');
    }
}