<?php
	...
	*/
	...
	$client  = new SoapClient('http://katedev112.armando.alliance-global.com/api/soap/?wsdl');
...
function GetCustomerIDList( $customer_email_list, $customer_tier_group_id ){ 
	...
	$j=0;
		for( $i=0; $i < count( $z_customer_email_list ); $i++ ){
			...
			$customer_email = $z_customer_email_list[$i];
